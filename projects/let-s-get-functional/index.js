...
var _ = require("lodown-abenezermulatu");
 ...
 *  //make sure to CD!! into abenezermulatu.github.io in terminal
...
var maleCount = function(array) {
    ...
    // return your high oder function to get to go
return _.filter(array,function(customer){
    // return a condition that resolves to a true or false based on the argument
...
var femaleCount = function(array){
    return _.reduce(array, function(count, value, currentIndex){
...
let youngerThanYoungName = array.reduce((youngest, person) => {
    // look over array to find the agese
    if(person.age < youngerThanYoung) {
        youngerThanYoung = person.age;
        return person.name; 
    }
// let the yougest be knonw 
return youngest;
},'');
// have the youngerThanYoungName 
...
});// lets get the size and total then '/'
...
var friendsCount = function(array, customerName){
    ...
    // let us look through persons for friends
...
var genderCount = function(array){
    ...
    // lets look over each person and find all females
let femmaleCount = _.reduce(array, function(femaleGender, person, i){
 ...
 return femaleGender;
    ...
    // lets look over each person and find all males
...
// lets look over each person and find all nonBinaries
